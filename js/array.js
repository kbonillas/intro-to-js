...
arr3.unshift('greetings'); // inserts 'greetings' to the beginning of arr3
console.log(arr3);

// arr3.splice(2,1,'kristin'); // removes 1 item at index 2 & add 'kristin" in that spot
// arr3.splice(2,2,); // remove 2 items starting at index 2
arr3.splice(2,2,'kristin', 'bonillas'); // remove 2 items starting at index 2, insert 'kristin' & 'bonillas' at index 2 & 3
console.log(arr3);
